...
function localisation2() {
    ...
    var url = "http://api.openweathermap.org/geo/1.0/direct?q=" + queryLoc + "&limit=1&appid=932bf7e3763f417ca65743decf57a796"
    ...
    fetch(url)
        ...
        // Appel de l'API en fonction de la latitude et la longitude de la ville
        var url1 = "http://api.openweathermap.org/data/2.5/air_pollution?lat=" + lat + "&lon=" + lon + "&appid=932bf7e3763f417ca65743decf57a796&lang=fr"
